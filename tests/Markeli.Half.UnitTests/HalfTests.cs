    ...
    public class HalfTests
    {
        ...
        public unsafe void TestAllPossibleHalfValues()
        {
            for (ushort i = ushort.MinValue; i < ushort.MaxValue; i++)
            {
                ...
                Assert.True(half1.Equals(half2));
            }
        }
        ...
        public void TryParseTest1()
        {
            ...
            float resultExpected = 12.34567f;
            
            bool expected = true;
            bool actual = float.TryParse(value, out var result);
        ...
        public void HalfConstructorTest3()
        {
            double value = 11.11;
            Half target = new Half(value);
            Assert.Equal((double)target, 11.109375);
        }
